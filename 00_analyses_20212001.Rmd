...
#TODO: mostly agree vs. rather agree??
...
p <- ggplot(dat, aes(y = pct_member, 
  ...
  scale_fill_manual(values = ColsPerCat_blind, 
                      ...
                      labels = NamesPerType$plot_names) +
...
df_meat <- nova_survey %>%
  filter(fill == 0) %>% 
  filter(!is.na(meat)) %>% 
  mutate(meat_diet = case_when (meat==7 ~ "Meat lover (n = 146)",
                              meat==6 ~ "Meat lover (n = 146)",
                              meat==5 ~ "Meat eater (n = 118)",
                              meat==4 ~ "Meat-flexitarian (n = 177)",
                              meat==3 ~ "Vegetarian-flexitarian (n = 183)",
                              meat==2 ~ "Meat avoider (n = 139)",
                              meat==1 ~ "Meat avoider (n = 139)", 
...
p <- ggplot(data = dat, 
  ...
  scale_x_discrete(limits=c("Meat avoider (n = 139)",
                            "Vegetarian-flexitarian (n = 183)",
                            "Meat-flexitarian (n = 177)",
                            "Meat eater (n = 118)",
                            "Meat lover (n = 146)"))+
